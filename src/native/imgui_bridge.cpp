...
ImVec4 meter_color(float value) {
    if (value >= 0.92f) return ImVec4(0.90f, 0.22f, 0.18f, 1.0f);
    if (value >= 0.78f) return ImVec4(0.97f, 0.56f, 0.14f, 1.0f);
    if (value >= 0.58f) return ImVec4(0.84f, 0.78f, 0.17f, 1.0f);
...
ImVec4 destination_kind_color(int kind) {
    switch (kind) {
        case 0: return ImVec4(0.25f, 0.78f, 0.96f, 1.0f);
        case 1: return ImVec4(0.95f, 0.60f, 0.16f, 1.0f);
        case 2: return ImVec4(0.34f, 0.86f, 0.45f, 1.0f);
        default: return ImVec4(0.72f, 0.72f, 0.76f, 1.0f);
    }
}
